# slighlty modified by D. Ceresoli
"""
...
try:
    ...
    libxc_path = ctypes.util.find_library("xc")

    # If we still havent found it, give up and throw an error
    if libxc_path is None:
        raise ImportError("LibXC Shared object not found, searched Python module local directory and library paths")
    
    # Load the C object
    core = ctypes.CDLL(libxc_path)
